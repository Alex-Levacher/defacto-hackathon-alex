...
introduction_record = ('Defacto API', 'Make your first loan in 5 minutes', introduction_content)
access_record = ('Defacto API', 'Get access to the API', access_content)
borrower_record = ('Defacto API', 'Create your borrower', create_borrower_content)
